...
func AdminStudentDetailHandler(generalData GeneralData, services impl.Services) http.HandlerFunc {
	return func(req *stdHttp.Request, res stdHttp.ResponseWriter) (interface{}, *http.ErrorWrapper) {
		var filepath = path.Join(getViewPath(), "admin_student_detail.html")
		...
		var data = map[string]interface{}{
			...
			"studentCollegeName":  getCollegeRes.College.Name,
