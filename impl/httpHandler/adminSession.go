...
func AdminSessionHandler(generalData GeneralData, services impl.Services) http.HandlerFunc {
	return func(req *stdHttp.Request, res stdHttp.ResponseWriter) (interface{}, *http.ErrorWrapper) {
		var filepath = path.Join(getViewPath(), "admin_session.html")
		...
		var data = map[string]interface{}{
			...
			"addSessionUrl":       fmt.Sprintf("%v%v", generalData.HostUrl, view.ADMIN_ADD_SESSION_PATH),
